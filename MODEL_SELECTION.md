...
- Qwen2.5 Instruct: 7B and 14B locally; 32B and 72B if Snellius access becomes available.
- Gemma 3 IT: 4B and 12B locally; 27B if Snellius or sufficient local quantization is available.

This gives a clearer scaling comparison than mixing Llama 2 13B with Qwen2.5 14B, because the selected families are more recent and provide multiple size points within the same generation.

## Why Qwen2.5

Qwen2.5 is a strong choice because it offers a dense size ladder of 0.5B, 1.5B, 3B, 7B, 14B, 32B, and 72B instruction-tuned models. This makes it well suited for testing whether quality improves with parameter count.
